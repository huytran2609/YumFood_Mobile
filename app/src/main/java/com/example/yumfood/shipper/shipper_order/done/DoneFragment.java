...
public class DoneFragment extends Fragment {
    ...
    private RecyclerView rcvDoneOrder;
    private DoneAdapter adapter;
    private List<Order> orders;

    private void initUi(ViewGroup view){
        rcvDoneOrder = view.findViewById(R.id.fragment_shipper_rcv_done_order);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        rcvDoneOrder.setLayoutManager(linearLayoutManager);
        orders = new ArrayList<>();
        adapter = new DoneAdapter(orders, getContext());
        rcvDoneOrder.setAdapter(adapter);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_done, container, false);
        initUi(view);
