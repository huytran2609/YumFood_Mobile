...
public class ProductFragment extends Fragment {
    ...
    private Seller_ProductGroupingforProductFragmentAdapter adapter;
    ...
    private void initUi()
    {
        ...
        adapter = new Seller_ProductGroupingforProductFragmentAdapter(productList, getContext());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fabAddNewProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent switchActivityIntent = new Intent(getContext(), SellerAddProductActivity.class);
        ...
        tvProductGrouping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent switchActivityIntent = new Intent(getContext(), SellerAddProductGroupingActivity.class);
                startActivity(switchActivityIntent);
            }
        });
    }
