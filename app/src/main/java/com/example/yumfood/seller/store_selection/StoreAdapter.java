...
import com.example.yumfood.seller.store_management.SellerStoreManagementActivity;
...
public class StoreAdapter extends RecyclerView.Adapter<StoreAdapter.StoreViewHolder>{
    ...
    {
        Intent switchActivityIntent = new Intent(this.context, SellerStoreManagementActivity.class);
