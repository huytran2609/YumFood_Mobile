    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDeleteProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new SweetAlertDialog(SellerUpdateProductActivity.this, SweetAlertDialog.WARNING_TYPE)
...
//                                        .show();
                                Toast.makeText(SellerUpdateProductActivity.this, "Đã xóa món ra khỏi thực đơn!", Toast.LENGTH_SHORT).show();
                                goFoodDatabase.deleteProduct(productInfo, SellerUpdateProductActivity.this);
                                finish();
                            }
                        })
        ...
        tvProductGrouping.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SellerUpdateProductActivity.this);
    ...
    private void getProductGroupingListFromRealtimeDatabase()
    {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(SellerUpdateProductActivity.this, "Không lấy được danh sách", Toast.LENGTH_SHORT).show();
            }
        });
    }
