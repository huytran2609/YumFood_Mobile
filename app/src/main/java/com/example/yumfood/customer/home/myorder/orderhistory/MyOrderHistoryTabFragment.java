...
import com.example.yumfood.customer.home.myorder.orderhistory.MyOrderHistoryTabAdapter;
...
public class MyOrderHistoryTabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_my_order_history_tab, container, false);
        initUI(root);
