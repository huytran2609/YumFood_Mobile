...
public class CustomerFavourite extends Fragment {
    ...
    private CustomerFavouriteAdapter adapter;

    private void initUi(ViewGroup root)
    {
        rcvStore = (RecyclerView) root.findViewById(R.id.fragment_customer_favourite_rcv_store);

        storeList = new ArrayList<>();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager( getContext());
        rcvStore.setLayoutManager(linearLayoutManager);
        adapter =  new CustomerFavouriteAdapter(storeList, getContext());
