...
import com.example.yumfood.customer.store_detail.ToppingBottomSheetDialog;
...
//    private boolean isProductHaveTopping = false;
    ...
    public ProductForStoreDetailAdapter.ProductForStoreDetailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_product_for_store_detail, parent,false);
        ...
        holder.btnAddToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (context instanceof StoreDetailActivity) {
                    ((StoreDetailActivity)context).setToppingBottomSheetDialog(toppingBottomSheetDialog);
                }
